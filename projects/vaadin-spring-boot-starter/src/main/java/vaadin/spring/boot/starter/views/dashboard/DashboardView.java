package vaadin.spring.boot.starter.views.dashboard;
...
//        monthlyVisitors.getConfiguration().getChart().setType(ChartType.COLUMN);
        ...
        JFreeChartWrapper jw = new JFreeChartWrapper(getChart());
        WrapperCard monthlyVisitorsWrapper = new WrapperCard("wrapper", new Component[]{jw}, "card");
...
//        responseTimes.getConfiguration().setTitle("Response times");
        JFreeChartWrapper jw2 = new JFreeChartWrapper(getChart());
        WrapperCard responseTimesWrapper = new WrapperCard("wrapper", new Component[]{jw2}, "card");
...
//        populateCharts();
    ...
    public JFreeChart getChart() {
        ...
        return ChartFactory.createHistogram("Normal distribution", "y values", "x values", dataset, PlotOrientation.VERTICAL, true, true, true);
    }
